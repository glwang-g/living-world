...
fn parse_block(value: &str) -> Option<Block> { Some(match value { "grass" => Block::Grass, "tree" => Block::Tree, "stone" => Block::Stone, "stone-wall" => Block::StoneWall, "water" => Block::Water, "dirt" => Block::Dirt, "placed-dirt" => Block::PlacedDirt, "wall" => Block::Wall, "torch" => Block::Torch, "switch-off" => Block::SwitchOff, "switch-on" => Block::SwitchOn, "wire" => Block::Wire, "door-closed" => Block::DoorClosed, "door-open" => Block::DoorOpen, _ => return None }) }
fn block_name(block: Block) -> &'static str { match block { Block::Grass => "grass", Block::Tree => "tree", Block::Stone => "stone", Block::StoneWall => "stone-wall", Block::Water => "water", Block::Dirt => "dirt", Block::PlacedDirt => "placed-dirt", Block::Wall => "wall", Block::Torch => "torch", Block::SwitchOff => "switch-off", Block::SwitchOn => "switch-on", Block::Wire => "wire", Block::DoorClosed => "door-closed", Block::DoorOpen => "door-open", Block::Unknown => "unknown" } }
